    ...
    return <div className={clsx(styles.container, "bg-[#320A8C] mt-[80px] w-screen")}>
        ...
        <div className={clsx(styles.banner, 'h-[800px] flex items-end px-16 py-48 gap-48')}>
            <div className="text-white">
                ...
                <p className="text-white mt-8 w-[400px]">We aim to extend SOLana network by... Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae ratione error similique dignissimos, ab totam consequuntur obcaecati? Hic libero nesciunt ducimus eaque fugit incidunt earum neque, accusantium et iste quod.</p>
            </div>
