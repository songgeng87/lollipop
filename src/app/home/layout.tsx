...
export default function HomeLayout({children}: { children: React.ReactNode }) {
    ...
    const handleScroll = (event: WheelEvent) => {
        childRef.current.handleScroll(event);
    };
    ...
    return <div className={clsx(styles.container, "bg-[#320A8C] mt-[80px] w-[100%] text-[16px] ")}>
        ...
        <div className={clsx("flex px-16 pt-16 overflow-x-hidden flex justify-between")}>
            <div
                ...
                <p className='font-SebneueSemiHeavy mb-2 text-[50px]'>The First Solan Native</p>
                <p className='font-SebneueSemiHeavy mb-2 text-[50px]'>Network Extension Service:</p>
                <p className=" font-SebneueSemiHeavy text-[#FC15EF] text-[50px]">Making SVM Portabl</p>
            ...
            <div className={clsx(styles.ballWrap)}>
        ...
        <div className={clsx("w-full flex justify-center gap-16 p-32")}>
            <Image width={1174} height={581} src="/images/video-page.png" alt="video"></Image>
        </div>
        ...
        <div className={clsx(styles.banner, 'h-[800px] flex items-end px-16 py-32 justify-between')}>
            <div ref={textRef}
                 className={clsx(styles.slideText, (isVisible ? styles.active : ''), " text-white")}>
                <p className="fn-SebneueSemiHeavy text-[42px] font-bold">EXTEND SOLANA</p>
                <p className="fn-SebneueSemiHeavy text-[42px] font-bold">WITH LOLLIPOP</p>
                <p className="font-ItalianRegular text-[24px] mt-8 max-w-[500px]">We aim to extend Solana mainnet by
            ...
            <div ref={textRef}
                 className={clsx(styles.slideText, (isVisible ? styles.active : ''), "grow flex flex-col items-center text-[#0AEAF1] font-bold ml-[200px]")}>
                <p className="fn-SebneueSemiHeavy text-[26px]">FAST DEPLOY A</p>
                <p className="fn-SebneueSemiHeavy text-[26px]">CUSTOMIZABLE SOLANA NETWORK EXTENSION</p>
                <button
                    className="text-[16px] w-[200px] h-[60px] mt-8 bg-[rgba(90, 10, 147, .4)] border-[#0AEAF1] border border-b-[6px] text-white rounded-full px-8 py-4 cursor-pointer hover:bg-[#FC15EF] active:bg-[#FC15EF] active:opacity-80 font-ItalianDemibold font-semibold">
