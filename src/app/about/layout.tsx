    ...
    return <div className={clsx(styles.container, 'text-white')}>
        <div className="px-16 py-48 min-h-[960px]">
            <div className="w-[98%] flex gap-2 items-center">
                ...
                <span
                    className={clsx((hoverPink ? styles['gradient-pink'] : ''), styles.max, styles.fadeInText, "w-4 h-4 ml-[-8px] border border-[#FC15EF] bg-[#FC15EF] rounded-full")}></span>
                ...
                <div className="flex flex-col gap-8 grow">
                    <div className="flex ml-[10vw]">
                        <div className="min-h-[10vw]">
                            ...
                            <p className={clsx((hoverBlue ? styles['gradient-blue'] : ''), styles.fadeInText, "w-4 h-4 ml-[8vw] mt-[-8px] border border-[#0AEAF1] bg-[#0AEAF1] rounded-full")}></p>
                        </div>
                        <div
                    ...
                    <div onMouseEnter={() => {
                        ...
                        Lollipop ls The First NES With Cryptographic Settlement
                        Protocols, Extended Mainnet Security, And Infrastructure
                        Compatibility With Solana At The Same Time. We Enable
                        The Creation Of Solana Native NES Networks For Dapps
                        And SVM Forks Or Ethereum Fork [L1&L2] To Settle On The
                        Solana Mainnet Through Lollipop Stack.
                    </div>
                </div>
                <div onMouseEnter={() => {
                    setHoverPink(true)
                    ...
                    setHoverPink(false)
                     ...
                     className={clsx(styles['shadow-inner'], styles.fadeInText, "border-[#FC15EF] border p-8 rounded-2xl ml-[5vw] h-[330px] w-[570px] overflow-auto")}>
                    <p className="font-ItalianDemibold text-[24px] font-medium">&ldquo;Write
                        Once, Deploy Anywhere&rdquo;</p>
                    <p className="font-ItalianRegular text-[18px] font-normal mt-6">Lollipop
                        Harnesses Solana's Robust.Infrastructure For High Security And Performance, While Integrating
                        Polkadot's
                        JAMAs An Optional Platform For Shared Sequencing, Data
                        Availability (DAl, And Stateless Validation. This Synergy
                        Empowers SVM Network Extensions With Superior
                        Performance, Enhanced Decentralization, And Seamless
                        Mobility Across Ecosystems.</p>
                </div>
            </div>
            <div className={clsx(styles.miniFlex, "w-full flex gap-2 items-center m-8")}>
                <span
                    className={clsx((hoverPink ? styles['gradient-pink'] : ''), "w-4 h-4 ml-[-8px] border border-[#FC15EF] bg-[#FC15EF] rounded-full")}></span>
            ...
            <div onMouseEnter={() => {
                ...
                setHoverPink(false)
                 ...
                 className={clsx(styles['shadow-inner'], styles.mini, "border-[#FC15EF] border p-8 rounded-2xl mt-4 h-[300px] overflow-auto")}>
